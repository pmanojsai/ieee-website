...
const Rampage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      ...
      <div className="relative overflow-hidden min-h-screen flex items-center" style={{
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 sm:py-20 md:py-32 text-center relative z-10 w-full">
          ...
          >
            ...
            >
              <div className="absolute -inset-1 sm:-inset-2 md:-inset-4 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold relative px-4 sm:px-0">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-100">RAMPAGE</span>
                <span className="block sm:inline text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-yellow-400 drop-shadow-[0_0_10px_rgba(250,204,21,0.5)]">v2.6</span>
              </h1>
              <motion.h2 
                className="text-xl sm:text-2xl md:text-3xl font-medium text-blue-200 mt-4 sm:mt-6 px-4 text-center sm:text-left"
            ...
            {/* Logos Section */}
            <motion.div 
              className="flex flex-wrap justify-center items-center gap-3 sm:gap-6 md:gap-8 py-4 sm:py-8 px-2 w-full max-w-5xl mx-auto"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link to="/register" className="group relative px-6 sm:px-8 py-3 sm:py-4 font-medium text-base sm:text-lg rounded-full overflow-hidden">
                  ...
                  <div className="relative flex items-center justify-center space-x-2 text-blue-900 font-bold text-sm sm:text-base">
      ...
      {/* Project Domains */}
      <section className="py-12 sm:py-16 bg-gray-50 dark:bg-gray-800 px-4">
      ...
      <section className="py-12 bg-gray-100 dark:bg-gray-800 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white sm:text-4xl">
      ...
      {/* Registration CTA */}
      <section id="register" className="py-12 bg-gradient-to-r from-blue-700 to-indigo-800 text-white px-4 sm:px-6 lg:px-8">
      ...
      {/* Schedule Section */}
      <section id="schedule" className="py-12 sm:py-16 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 px-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white sm:text-4xl">
      ...
      <section className="py-12 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 px-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white sm:text-4xl">
            ...
            {eventImages.map((image, index) => (
              ...
              >
                <img
                  src={image.src}
                  alt={image.alt}
                  className="w-full h-40 sm:h-56 md:h-64 object-cover transition-transform duration-500 group-hover:scale-110"
                  loading="lazy"
                />
