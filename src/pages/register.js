        ...
        <li className="flex items-start">
          ...
          <span>Decisions of the RAMpage V2.6 Organizing Team are final.</span>
            ...
            <div className="grid md:grid-cols-2 gap-0 md:gap-8 items-start">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-gray-200 dark:border-gray-600 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Scan to Register</h2>
                 ...
                 <p className="bg-red-50 dark:bg-red-900/30 border border-red-600 text-red-600 dark:text-red-400 font-bold p-4 rounded-lg">Important Update: Registrations for the Web Development domain have officially reached maximum capacity and are now closed. Please select an alternative domain for your team.</p>
                </div>
                
              {/* Problem Statements Section */}
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-gray-200 dark:border-gray-600 mt-6">
